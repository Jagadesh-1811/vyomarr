    ...
    <div className="vy-blog-wrap">
      <div style={{ maxWidth: 980, margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 16, marginBottom: 24 }}>
          <div style={{ background: 'rgba(0, 11, 73, 0.6)', border: '1px solid rgba(236, 72, 153, 0.3)', borderRadius: 14, padding: 24, textAlign: 'center', backdropFilter: 'blur(10px)', transition: 'all 0.3s ease' }}>
            ...
            <div style={{ color: '#bfc3c6', fontSize: 14, marginTop: 4 }}>Total Subscribers</div>
          </div>
          <div style={{ background: 'rgba(0, 11, 73, 0.6)', border: '1px solid rgba(16, 185, 129, 0.3)', borderRadius: 14, padding: 24, textAlign: 'center', backdropFilter: 'blur(10px)', transition: 'all 0.3s ease' }}>
            <div style={{ fontSize: 36, fontWeight: 700, color: '#34d399' }}>{activeCount}</div>
            <div style={{ color: '#bfc3c6', fontSize: 14, marginTop: 4 }}>Active</div>
          </div>
          <div style={{ background: 'rgba(0, 11, 73, 0.6)', border: '1px solid rgba(107, 114, 128, 0.3)', borderRadius: 14, padding: 24, textAlign: 'center', backdropFilter: 'blur(10px)', transition: 'all 0.3s ease' }}>
            <div style={{ fontSize: 36, fontWeight: 700, color: '#9ca3af' }}>{inactiveCount}</div>
            <div style={{ color: '#bfc3c6', fontSize: 14, marginTop: 4 }}>Inactive</div>
          </div>
        </div>

        <div style={{ background: 'rgba(0, 11, 73, 0.6)', border: '1px solid rgba(236, 72, 153, 0.25)', borderRadius: 16, padding: 0, overflow: 'hidden', backdropFilter: 'blur(10px)' }}>
