...
import { Rocket, Sparkles, FileText, MessageSquare, MessagesSquare, Users, LogOut } from 'lucide-react';
import '../../src/App.css';
...
export default function Sidebar({ activeSection, setActiveSection, sidebarOpen, setSidebarOpen }) {
  return (
    <aside style={{ 
      ...
      <div style={{ 
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          <div style={{
            ...
            boxShadow: '0 4px 15px rgba(252,76,0,0.4)'
          }}>
      ...
      {/* Navigation */}
      <nav style={{ flex: 1, display: 'flex', flexDirection: 'column', padding: '20px 12px', gap: '8px' }}>
        {MENU_ITEMS.map((item) => {
